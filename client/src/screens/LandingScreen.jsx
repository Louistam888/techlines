...
export const LandingScreen = () => (
  <Box maxW="8xl" mx="auto" px={{ base: '0', lg: '12' }} py={{ base: '0', lg: '12' }} minH="6x1">
    <Stack direction={{ base: 'column-reverse', lg: 'row' }} spacing={{ base: '0', lg: '20' }}>
      ...
      >
        <Stack spacing={{ base: '8', lg: '10' }}>
          ...
          <HStack spacing="3">
            <Link as={ReactLink} to="/" color={useColorModeValue('orange.500', 'orange.300')} fontWeight="bold" fontSize="lg">
              Discover now
            </Link>
